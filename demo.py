...
def main():
    ...
    print("🧪 MOCK MODE - Using test data" if mode == "mock" else "🌐 REAL MODE - Using live ProPublica API")
    ...
    for ein in eins:
        ...
        try:
            ...
            additional_msg = "\nThis might be due to API rate limiting or network issues" if mode == "real" else ""
